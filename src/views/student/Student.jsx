...
const Student = () => {
      ...
      if (!response.ok) {
        if (response.problem === "NETWORK_ERROR") {
          ...
          if (typeof serverMessage === "string") {
            ...
            errorText = "Failed to verify sangira";
          }
  ...
  const loadApplicationWindow = async () => {
    ...
    try {
      const response = await apiClient.get(`/check-semester`);
      ...
      if (!response.ok) {
        ...
        if (response.problem === "NETWORK_ERROR") {
          ...
          toast.error(
            typeof serverMessage === "string"
              ? serverMessage
              : "Failed to validate student number",
          );
        }
        return;
      }
  ...
  const submitForm = async () => {
    ...
    try {
      const basePrice = selectedRoomPrice.Price * quantity;
      const cautionPrice = validatedData?.cautionMoney?.Item_Price || 0;
      const shouldAddCaution = validatedData?.cautionStatus === "make_payment";

      const data = {
        Student_ID: studentData?.Student_ID || studentId,
        Room_ID: selectedRoom.id,
        Grand_Total_Price: shouldAddCaution
          ? basePrice + parseInt(cautionPrice)
          : basePrice,
        Request_Type: "hostel",
        ...
        items: [
          ...
          ...(shouldAddCaution && validatedData?.cautionMoney
            ? [
                {
                  Request_Type: "hostel",
                  Quantity: 1,
                  Item_ID: validatedData.cautionMoney.Item_ID,
                  Price: validatedData.cautionMoney.Item_Price,
                },
              ]
            : []),
        ],
      ...
      if (!response.ok) {
        ...
        if (response.problem === "NETWORK_ERROR") {
          ...
          toast.error(
            typeof serverMessage === "string"
              ? serverMessage
              : "Failed to submit student accommodation details",
          );
        }
        return;
      }
  ...
  const newFormatCountdown = (seconds) => {
  ...
  return (
    <>
      {windowLoading ? (
        ...
        <>
          {appWindow?.status === "closed" ? (
            <ApplicationClosed academicYear={appWindow} />
          ) : (
            <div
            ...
            >
              {showRegisterForm ? (
                <RegisterStudent onBack={() => setShowRegisterForm(false)} />
              ) : (
                    ...
                    <div className="space-y-6">
                      <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                        ...
                        <p className="text-gray-600 mb-6">
                          Please enter your student number to manage your
                          accommodations.
                        </p>
                        ...
                        <div className="space-y-4">
                          ...
                          {/* Give access to unregistered students link */}
                          <div className="text-center">
                            <p className="text-gray-600 mb-3">
                              Can't access the accommodation system?
                            </p>
                            <button
                              onClick={() => setShowRegisterForm(true)}
                              className="cursor-pointer inline-flex items-center gap-2 px-6 py-3 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition-all duration-200 shadow-md hover:shadow-lg"
                            >
                              <LuUserPlus className="w-5 h-5" />
                              Register here
                            </button>
                            <p className="text-xs text-gray-500 mt-3">
                              All students who cannot access the accommodation
                              system can register here to gain access
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  {currentStep === 3 && invoiceData && (
                    <div className="space-y-6">
                      ...
                      >
                        ...
                        {invoiceData?.Sangira_Status === "pending" ? (
                          <p className="text-gray-600">
                            Please complete your payment using the details
                            below. The Sangira Number expires in 24 hours.
                          </p>
                        ) : (
                          <p className="text-gray-600">
                            Your payment has been received. Please visit you
                            wardens office for further instructions.
                          </p>
                        )}
                      </div>
                                    ...
                                    <>
                                      ...
                                      <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                                        ...
                                        <p className="text-sm text-gray-600 mb-4">
                                          ...
                                          processed. You can now print a receipt
                                          of your records.
                                        </p>
                                        <button
                                    ...
                                    <>
                                      ...
                                      <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                        ...
                                        <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
                                          <li>
                                            Use the payment number above to
                                          ...
                                          <li>
                                            After payment, your accommodation
                                            will be confirmed
                                          </li>
                                          <li>
                                            Keep this payment number for your
                                            records
                                          </li>
                                        </ul>
                                      </div>
                                  ...
                                  {countdown < 300 && (
                                    <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                                      <p className="text-sm font-semibold text-red-700">
                                        ⚠️ Time is running out! Please complete
                                        your payment soon.
                                      </p>
                                    </div>
                                  )}
                                  ...
                                  {countdown === 0 && (
                                    <div className="bg-red-100 rounded-lg p-4 border-2 border-red-300">
                                      ...
                                      <p className="text-xs text-red-700">
                                        This invoice is no longer valid. You
                                        will be redirected to start a new
                        ...
                        <TabPanel value={tabValue} index={1}>
                          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
                            <h3 className="text-xl font-semibold text-gray-800 mb-4">
                              How to Complete Your Payment via CRDB / NMB
                              Banking
                            </h3>
                                  ...
                                  <div className="space-y-4">
                                    <div className="flex items-start gap-3">
                                      ...
                                      <div>
                                        ...
                                        <div className="mt-1 bg-gray-50 p-3 rounded-lg border border-gray-200">
                                          <p className="text-gray-700">
                                            Launch CRDB Simbanking app on your
                                            phone
                                          </p>
                                        </div>
                                      </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                      ...
                                      <div>
                                        ...
                                        <div className="mt-1 bg-gray-50 p-3 rounded-lg border border-gray-200">
                                          <p className="text-gray-700">
                                            Navigate to "Huduma ya Hospital"
                                            (Hospital Services)
                                          </p>
                                        </div>
                                      </div>
                                ...
                                <div className="ml-11">
                                  <ul className="space-y-2 text-gray-700">
                                    <li className="flex items-start gap-2">
                                      ...
                                      <span>
                                        Keep your Sangira Number safe for future
                                        reference
                                      </span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                  ...
                                  <div className="mt-4 p-4 bg-red-50 rounded-lg border border-red-200">
                                    ...
                                    <div className="flex items-center justify-between">
                                      <p className="text-gray-700">
                                        Complete your payment before time runs
                                        out
                                      </p>
                                      <div
                            ...
                            <div className="space-y-6">
                              ...
                              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                                ...
                                <p className="text-gray-600 mb-4">
                                  You can print this form for your records or to
                                  submit to the warden's office.
                                </p>
