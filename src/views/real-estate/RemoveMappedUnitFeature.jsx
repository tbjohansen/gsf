...
const RemoveMappedUnitFeature = ({ feature, loadData }) => {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const response = await apiClient.delete(
        `/settings/real-estate-assigned-feature/${feature?.id}`,
        data
      );
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            Are you sure you want to remove this assigned feature ?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
...
export default RemoveMappedUnitFeature;
