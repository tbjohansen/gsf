...
const HouseRequestLetter = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        setLoading(false);
        toast.error(response.data?.error || "Failed to fetch house unit");
        return;
      }
      ...
      console.error("Fetch house unit error:", error);
      setLoading(false);
      toast.error("Failed to load house unit");
    }
  };
  ...
  const handleSendRequest = async (e) => {
    ...
    if (!unit) {
      toast.error("Please select house unit to request");
      return;
    }
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6">
              ...
              <h1 className="text-3xl font-bold text-center mb-2">
                House Allocation Request Letter
              </h1>
            ...
            <div className="p-6">
              ...
              <textarea
                ...
                placeholder="Start writing your house allocation request letter here..."
              />
            </div>
...
export default HouseRequestLetter;
