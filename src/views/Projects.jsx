...
const Projects = () => {
  ...
  const permission = JSON.parse(userData);
  ...
  return (
    <div className="min-h-screen bg-white-900 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {permission?.Can_Access_Hostel === "yes" ? (
          <div
          ...
          <div
            onClick={() =>
              toast(
                "Sorry! You don't have access to open this feature. Please contact administrator",
              )
            }
        ...
        {permission?.Can_Access_Oxygen === "yes" ? (
          <div
            className="rounded-lg p-4 bg-[rgb(22,40,79)] cursor-pointer shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105"
        ...
        {permission?.Can_Access_Real_Estate === "yes" ? (
          <div
            className="rounded-lg p-4 bg-[rgb(22,40,79)] cursor-pointer shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105"
        ...
        {permission?.Can_Access_Farm === "yes" ? (
          <div
            className="rounded-lg p-4 bg-[rgb(22,40,79)] cursor-pointer shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105"
          ...
          >
            ...
            <div className="mt-3">
              <h3 className="text-white text-xl font-semibold">{farms?.length || 0}</h3>
            </div>
          </div>
        ) : (
          <div
          ...
          >
            ...
            <div className="mt-3">
              <h3 className="text-gray-400 text-xl font-semibold">{farms?.length || 0}</h3>
            </div>
          </div>
        )}
